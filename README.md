...
🔐 What I Work With Programming: Python, Java, C++ Cybersecurity: Vulnerability Assessment, Web Security, OWASP Top 10, Threat Modeling Networking: TCP/IP, HTTP, Network Traffic Analysis, Firewalls Tools: Wireshark, Nmap, Dirb/Dirbuster, Docker, Git Platforms: Linux (Ubuntu/Kali), VS Code

🚀 Projects 

I'm using this GitHub to document projects and labs that reflect what I'm learning, including:

Network Vulnerability Scanner — Python-based network reconnaissance and service discovery Security Log Analyzer — analyzing authentication and system events for suspicious activity Web Application Security Assessment — controlled testing based on selected OWASP Top 10 risks Network Traffic Analysis Lab — investigating packets and HTTP traffic with Wireshark Home Cybersecurity Lab — Linux and virtual-machine based security practice 
